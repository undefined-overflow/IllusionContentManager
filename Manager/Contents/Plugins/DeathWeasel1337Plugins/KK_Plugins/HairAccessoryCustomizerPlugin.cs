...
namespace Manager.Contents.Plugins.DeathWeasel1337Plugins.KK_Plugins
{
    ...
    [Plugin("84FBB59C-3683-417A-AB80-A6E2B65CD38B", typeof(BepInExPlugins.BepInExPlugin))]
    public sealed class HairAccessoryCustomizerPlugin : GitPlugin
    {
        public HairAccessoryCustomizerPlugin()
        {
