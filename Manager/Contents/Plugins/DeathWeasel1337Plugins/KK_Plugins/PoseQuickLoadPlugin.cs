...
namespace Manager.Contents.Plugins.DeathWeasel1337Plugins.KK_Plugins
{
    ...
    [Plugin("3415C03A-CCC1-406A-87E1-D8C7633CD037", typeof(BepInExPlugins.BepInExPlugin))]
    public sealed class PoseQuickLoadPlugin : GitPlugin
    {
        public PoseQuickLoadPlugin()
        {
