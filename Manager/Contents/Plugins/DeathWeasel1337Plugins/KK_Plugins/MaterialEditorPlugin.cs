...
namespace Manager.Contents.Plugins.DeathWeasel1337Plugins.KK_Plugins
{
    ...
    [Plugin("F6D0B65B-7EBA-47E8-BB69-03733F0A2696", typeof(BepInExPlugins.BepInExPlugin))]
    public sealed class MaterialEditorPlugin : GitPlugin
    {
        public MaterialEditorPlugin()
        {
